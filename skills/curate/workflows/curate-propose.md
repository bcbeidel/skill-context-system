...
```bash
python ${CLAUDE_PLUGIN_ROOT}/skills/curate/scripts/propose.py --kb-root <kb_root> --topic "<topic_name>" --relevance "<relevance>" --proposed-by "<proposed_by>" --rationale "<rationale>"
```

## Step 3: Report what was created

Show the user the proposal file that was created:
- `knowledge/_proposals/<slug>.md`

## Step 4: Explain the proposal lifecycle

"The proposal has been created in `knowledge/_proposals/`. Next steps:
...
<success_criteria>
- Proposal file created in knowledge/_proposals/
